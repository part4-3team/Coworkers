    ...
    >
      ...
      >
        ...
        >
          ...
          {primaryButtonText && (
            <button
              className="bg-brand-primary rounded-xl px-4 py-2.75 w-full text-white font-medium hover:bg-interaction-hover"
          ...
          {subButtonText && (
            <button
              className="bg-status-danger rounded-xl px-4 py-2.75 w-full text-white font-medium hover:bg-status-hover"
