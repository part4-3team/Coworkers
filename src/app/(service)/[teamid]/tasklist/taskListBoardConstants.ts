...
export const TASK_LIST_BOARD_CARD_SHELL_CLASS = cn(
  'flex w-full min-w-0 flex-1 flex-col rounded-[20px] bg-background-primary px-4 py-6 shadow-[0_15px_50px_-12px_rgba(0,0,0,0.05)] sm:px-5 sm:py-8 md:px-8 md:py-10',
);
